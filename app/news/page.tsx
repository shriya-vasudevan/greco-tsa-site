...
export default async function News () {
    ...
    return (
        <>
            ...
            {/* <div className="p-8">
            {
                <NewsCard key={data.articles[0].title} url={data.articles[0].url} title={data.articles[0].title} image={data.articles[0].urlToImage} published={data.articles[0].publishedAt.slice(0, 10)} description={data.articles[0].description}/>
            }
            </div> */}
            <div className="relative grid grid-flow-row auto-rows-max md:grid-cols-2 items-end justify-center overflow-hidden p-8">
                {data.articles ? (
                    // d = data.articles.slice(0)
